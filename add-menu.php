...
// if everything is ok, try to upload file
  ...
  if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
      ...
      $q = $_POST["quantity"];
      $price = $_POST["price"];
     $sql = "INSERT INTO menu (description, quantity, price, image) VALUES ('$name', '$q', $price, '$target_file')";
    ...
    <div class="div-center card">
      <form action="" method="POST" enctype="multipart/form-data">
          <div class="container">
              ...
              <input type="file" placeholder="Enter Quantity" name="fileToUpload" required>
    
    
              
              <div class="clearfix">
                    <button type="submit" name="submit" class="signup">Add Item</button>
              </div>
            </div>
      </form>
    </div>
